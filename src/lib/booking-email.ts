...
/**
 * Builds a branded HTML admin cancellation email.
 * Sent when the clinic (not the patient) cancels an appointment.
 * Distinct from buildCancellationEmail: different header, clinic-cancelled messaging,
 * optional reason field, and a softer CTA (text link rather than large button).
 */
...
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>Időpont lemondva a rendelő által</title>
</head>
<body style="margin: 0; padding: 0; background-color: #F0F2F5; font-family: ui-sans-serif, system-ui, -apple-system, Arial, sans-serif;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" role="presentation"
          ...
          <tr>
            <td style="background-color: ${navy}; padding: 32px 40px;">
              ...
              <h1 style="margin: 8px 0 0; font-size: 22px; font-weight: 700; color: #ffffff; line-height: 1.3;">
                A rendelő lemondta az Ön időpontját
              </h1>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 32px 40px 0;">
              ...
              <p style="margin: 12px 0 0; font-size: 15px; color: ${textMuted}; line-height: 1.7;">
                Sajnálattal értesítjük, hogy a rendelő lemondta az alábbi időpontját. Az esetleges kellemetlenségért elnézést kérünk.
              </p>
            </td>
          </tr>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" role="presentation"
                ...
                <tr>
                  <td style="padding: 16px 20px;">
                    <p style="margin: 0 0 6px; font-size: 11px; font-weight: 700; color: ${textMuted}; text-transform: uppercase; letter-spacing: 0.07em;">
                      Indoklás
                    </p>
                    <p style="margin: 0; font-size: 14px; color: ${textDark}; line-height: 1.6;">
                      ${reason}
          ...
          <tr>
            <td style="padding: 28px 40px 0;">
              <p style="margin: 0 0 14px; font-size: 14px; color: ${textMuted}; line-height: 1.6;">
                Ha szeretne új időpontot foglalni, kattintson az alábbi linkre, vagy hívjon minket telefonon.
              </p>
              <table cellpadding="0" cellspacing="0" role="presentation">
                <tr>
                  <td style="padding-right: 12px;">
                    <a href="${newBookingUrl}"
                      style="display: inline-block; padding: 10px 20px; background-color: ${lightGrey}; color: ${navy}; text-decoration: none; border-radius: 6px; font-size: 14px; font-weight: 600; border: 1px solid #E5E7EB;">
                      Új időpont foglalása
                    </a>
                  </td>
                  <td>
                    <a href="${mapsUrl}"
                      style="display: inline-block; padding: 10px 20px; background-color: ${green}; color: ${navy}; text-decoration: none; border-radius: 6px; font-size: 14px; font-weight: 600;">
                      Útvonal
                    </a>
                  </td>
                </tr>
